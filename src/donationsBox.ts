...
const donationBoxButton1 = new GLTFShape('models/JustTheTip/Comedy_CryptoBox_Button_1_2.glb')
const donationBoxButton5 = new GLTFShape('models/JustTheTip/Comedy_CryptoBox_Button_5_2.glb')
const donationBoxButton10 = new GLTFShape('models/JustTheTip/Comedy_CryptoBox_Button_10_2.glb')
const donationBoxButton20 = new GLTFShape('models/JustTheTip/Comedy_CryptoBox_Button_20_2.glb')



export class DonationButton1 extends Entity {
  ...
  constructor(
    ...
    this.addComponent(donationBoxButton1)
...
export class DonationButton5 extends Entity {
  animation: AnimationState
  idleAnimation: AnimationState
  address: string
  defaultAmount: number
  ...
  constructor(
    ...
    this.addComponent(donationBoxButton5)
    this.addComponent(new Transform(pos))
...
export class DonationButton10 extends Entity {
  animation: AnimationState
  idleAnimation: AnimationState
  address: string
  defaultAmount: number
  ...
  constructor(
    ...
    this.addComponent(donationBoxButton10)
...
export class DonationButton20 extends Entity {
  animation: AnimationState
  idleAnimation: AnimationState
  address: string
  defaultAmount: number
  ...
  constructor(
    ...
    super()
    engine.addEntity(this)
    this.addComponent(donationBoxButton20)
